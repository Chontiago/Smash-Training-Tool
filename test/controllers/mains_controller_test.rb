...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { Best_Stage: @main.Best_Stage, Character: @main.Character, Win_rate: @main.Win_rate, Worst_Stage: @main.Worst_Stage } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { Best_Stage: @main.Best_Stage, Character: @main.Character, Win_rate: @main.Win_rate, Worst_Stage: @main.Worst_Stage } }
